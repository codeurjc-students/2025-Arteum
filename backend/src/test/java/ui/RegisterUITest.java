...
class RegisterUITest {
	...
	@Test
	void testUserRegisterAndDashboard() {
		...
		userField.sendKeys("qwerty123456789");
		driver.findElement(By.id("email")).sendKeys("qwerty123456789@arteum.com");
		...
		assertTrue(driver.getCurrentUrl().contains("login"), "Should navigate to the dashboard after register");
	}
